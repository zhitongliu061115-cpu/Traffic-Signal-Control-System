...
with digits(n) as (
    ...
    select
        n,
        8.4 + 2.8 * sin(n / 37.0) + 0.9 * sin(n / 11.0) as queue_value,
        35 + 14 * sin(n / 41.0) + 5 * sin(n / 13.0) as wait_value,
        920 + 310 * sin(n / 31.0) + 120 * sin(n / 7.0) as flow_value,
        86 + 12 * sin(n / 29.0) + 4 * sin(n / 9.0) as saturation_value
    from numbered
)
